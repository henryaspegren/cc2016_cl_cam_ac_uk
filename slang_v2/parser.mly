...
%token<int> INT
%token<string> IDENT
%token EOF LPAREN RPAREN COMMA COLON SEMICOLON ADD SUB MUL DIE NOT EQUAL LT ANDOP OROP 
...
%left MUL DIE ANDOP OROP EQUAL ARROW  LT /* medium precedence */
%left ASSIGN              
/*
%nonassoc THEN    
%nonassoc ELSE    
...
| expr DIE expr 					 { Past.Op(get_loc(), $1, Past.DIE, $3) }
